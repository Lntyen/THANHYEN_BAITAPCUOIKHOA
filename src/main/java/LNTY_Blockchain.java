...
public class LNTY_Blockchain {
    public static ArrayList<VNPT_Yen> blockchain = new ArrayList<VNPT_Yen>();
    public static int difficulty = 5;
    public static float minimumTransaction = 0.1f;
    public static LNTY_Store LNTY_Kho; //Kho
    public static LNTY_Store LNTY_Cuahang; //Cửa hàng
    ...
    public static void main(String[] args) {
        ...
        //Tạo ra các store
        LNTY_Kho = new LNTY_Store();
        LNTY_Cuahang = new LNTY_Store();
        LNTY_Store coinbase = new LNTY_Store();
        ...
        genesisTransaction = new Transaction(coinbase.publicKey, LNTY_Kho.publicKey, initBalanceA, null);
        ...
        addBlock(genesis);
        System.out.println("-Số lượng VNPT-Net Router trong kho là : " + LNTY_Kho.getBalance());
        ...
        genesisTransaction = new Transaction(coinbase.publicKey, LNTY_Cuahang.publicKey, initBalanceB, null);
        genesisTransaction.generateSignature(coinbase.privateKey); //Gán private key (ký thủ công) vào giao dịch gốc
        ...
        genesis.addTransaction(genesisTransaction);
        addBlock(genesis);
        System.out.println("-Số lượng VNPT-Net Router đang có tại Cửa hàng là : " + LNTY_Cuahang.getBalance());
        ...
        while (fail){
            ...
            sendFund = LNTY_Kho.sendFunds(LNTY_Cuahang.publicKey, numberTransfer);
            if (sendFund==null){
                continue;
            }else{
                fail= false;
        ...
        System.out.println("-Số lượng VNPT-Net Router trong kho hiện tại là : " + LNTY_Kho.getBalance());
        System.out.println("-Số lượng VNPT-Net Router của Cửa hàng hiện tại là : " + LNTY_Cuahang.getBalance());
    }
